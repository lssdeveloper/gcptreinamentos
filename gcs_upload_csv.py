...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:/Users/Leandro/PycharmProjects/gcptreinamentos/apikey.json"
...
def upload_csv():
    ...
    source_file_name = 'C:/Users/Leandro/PycharmProjects/gcptreinamentos/output/'
    ...
    for file in files:
        ...
        object_name_in_gcs_bucket = bucket.blob(f"output/csv/{file}")
